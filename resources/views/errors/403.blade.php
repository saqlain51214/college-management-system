...
<head>
    ...
    <title>Access Denied — Jinnah Degree College Astore</title>
    <style>
...
<body>
    <div class="card">
        ...
        <h1>Access Denied</h1>
        <p>You don’t have permission to view this page. If you believe this is a mistake, please contact the administrator.</p>
        <div class="btns">
