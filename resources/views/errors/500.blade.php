...
<head>
    ...
    <title>Something Went Wrong — Jinnah Degree College Astore</title>
    <style>
        ...
        * { margin: 0; box-sizing: border-box; }
        ...
        a.btn { display: inline-block; padding: 12px 24px; border-radius: 10px; font-weight: 700; font-size: 14px; text-decoration: none; transition: opacity .2s, background .2s; }
...
<body>
    <div class="card">
        ...
        <p>An unexpected error occurred on our side. Please try again in a moment. If it keeps happening, contact the administrator.</p>
        <div class="btns">
