...
<head>
  ...
  <title>Reset Password — Student Portal — JDCA</title>
...
<div class="w-full max-w-md">
  ...
  <div class="portal-auth-card rounded-3xl p-8">
    ...
    <div class="mt-6 pt-5 text-center text-xs" style="border-top: 1px solid rgba(255,255,255,0.08)">
      <a href="{{ route('portal.password.request') }}" class="text-slate-300 hover:text-white">Didn't get a code? Try again</a>
    </div>
  </div>
</div>
</body>
