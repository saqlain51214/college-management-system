  ...
  <nav class="flex-1 px-3 py-3 overflow-y-auto space-y-0.5">
    @php
      $navLinks = [
        ...
        ['route' => 'teacher.salary',    'label' => 'My Salary',  'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
        ...
        ['route' => 'teacher.notifications', 'label' => 'Notifications', 'icon' => 'M20 13V7a2 2 0 00-2-2H6a2 2 0 00-2 2v6m16 0l-2.5 5.5a1 1 0 01-.9.5H9.4a1 1 0 01-.9-.5L6 13m14 0h-4l-1 2h-6l-1-2H4', 'badge' => auth('teacher')->user()?->unreadNotifications()->count()],
    ...
    @foreach($navLinks as $link)
      ...
      <a href="{{ route($link['route']) }}" @click="sidebarOpen = false"
        ...
        @if(!empty($link['badge']))
          <span class="text-[10px] font-bold px-1.5 py-0.5 rounded-full" style="background:#c4973a;color:#1c1917">{{ $link['badge'] }}</span>
        @endif
      </a>
    @endforeach
  </nav>
