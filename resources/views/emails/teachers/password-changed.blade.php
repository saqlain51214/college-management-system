...
<p style="margin:0 0 20px;">Your teacher portal password was changed successfully.</p>
...
<p style="margin:0; padding:14px 16px; background:#fdf3f4; border-left:3px solid #6b2d39; border-radius:6px; font-size:13px;">
    If you did <strong>not</strong> make this change, please contact the administration immediately.
</p>
@endsection
