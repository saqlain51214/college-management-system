    ...
    <tr>
      ...
      <td style="width:22%;vertical-align:middle;">
        @if(!empty($template->bank_logo_path) && is_file(storage_path('app/public/' . $template->bank_logo_path)))
          <img src="{{ storage_path('app/public/' . $template->bank_logo_path) }}" style="max-width:48pt;max-height:40pt;display:block;"/>
        @elseif(is_file(public_path('assets/images/default/kcbl-logo-web.png')))
          <img src="{{ public_path('assets/images/default/kcbl-logo-web.png') }}" style="max-width:48pt;max-height:40pt;display:block;"/>
        @else
      ...
      <td style="width:24%;vertical-align:middle;text-align:right;">
        @if(!empty($template->logo_path) && is_file(storage_path('app/public/' . $template->logo_path)))
          <img src="{{ storage_path('app/public/' . $template->logo_path) }}" style="max-width:48pt;max-height:40pt;display:inline-block;"/>
        @elseif(is_file(public_path('assets/images/default/cologe-logo-web.png')))
          <img src="{{ public_path('assets/images/default/cologe-logo-web.png') }}" style="max-width:48pt;max-height:40pt;display:inline-block;"/>
        @else
