...
class StudentPortalController extends Controller
{
    ...
    public function fees()
    {
        ...
        $slipCount      = $payments->count();

        return view('portal.fees', compact('student', 'payments', 'summary', 'feeTypeOptions', 'slipFeeType', 'invoice', 'slipCount'));
    }
    ...
    public function generateSlip(Request $request)
    {
        ...
        $invoice = FeePayment::invoiceSummary($student, $request->input('fee_type'), $student->current_semester, $student->academic_year_id);
        ...
        try {
            $slip = FeePayment::generateSlip($student, [
                ...
                'amount'           => $amount,
                'remarks'          => 'Self-generated by student via portal (' . $request->input('mode') . ').',
            ]);
