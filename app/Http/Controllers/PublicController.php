...
class PublicController extends Controller
{
    ...
    /** Shared render for the fee-challan lookup page. */
    private function renderFeeChallanLookup(string $identifier, ?string $notFoundError = null)
    {
        $college = $this->college();
